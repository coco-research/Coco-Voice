//! Model capability probing — the seam between Coco Voice's model UI and "what can
...
/// How confident we are that Coco Voice can run a given model, judged from its GGUF
