{
  description = "Coco Voice - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          coco-voice = pkgs.rustPlatform.buildRustPackage {
            pname = "coco-voice";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/coco-research/Coco-Voice";
              license = lib.licenses.mit;
              mainProgram = "coco-voice";
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.coco-voice.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.coco-voice;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.coco-voice.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.coco-voice;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Coco Voice development environment"
              bun install
