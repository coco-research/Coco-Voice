...
const settingUpdaters: {
  ...
  corrections: (value) => commands.updateCorrections(value as CorrectionPair[]),
  ...
  iterative_correction_enabled: (value) =>
    commands.changeIterativeCorrectionSetting(value as boolean),
